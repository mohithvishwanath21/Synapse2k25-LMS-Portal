        ...
        <Card className="border-0 shadow-md hover:shadow-lg transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm font-semibold text-black">Total Earnings</p>
                <p className="text-2xl font-bold mt-1 text-green-600 dark:text-green-400">
                  {formatCurrency(walletData?.totalEarnings)}
                </p>
                <p className="text-xs text-muted-foreground mt-1">Lifetime earnings from all sources</p>
              </div>
              <div className="bg-white dark:bg-green-900/20 p-3 rounded-full">
      ...
      <motion.div variants={itemVariants}>
        <Card className="border-0 shadow-md hover:shadow-lg transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm font-semibold text-black">Total Withdrawals</p>
              ...
              <div className="bg-white dark:bg-amber-900/20 p-3 rounded-full">
      ...
      <motion.div variants={itemVariants}>
        <Card className="border-0 shadow-md hover:shadow-lg transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm font-semibold text-black">Net Earnings</p>
                <p className="text-2xl font-bold mt-1 text-blue-600 dark:text-blue-400">
                  {formatCurrency(netEarnings)}
                </p>
                <p className="text-xs text-muted-foreground mt-1">Total earnings minus withdrawals</p>
              </div>
              <div className="bg-white dark:bg-blue-900/20 p-3 rounded-full">
                <Wallet className="h-6 w-6 text-black dark:text-blue-400" />
              </div>
            </div>
          </CardContent>
        </Card>
